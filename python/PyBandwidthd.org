* PyBandwidthd
If you want to support arbitrary databases, or provide mac addresses or other labels in real-time, this is the way to do
it. It also gives you access to the SVG generator, either with data pulled from databases, or live data.

#+begin_src c++ :tangle PyBandwidthd.cpp
import BandwidthD;
import format_ip;
...
struct PythonSensor: public Sensor<PythonSensor, Modes::BothDefault> {
...
PYBIND11_MODULE(PyBandwidthD, m) {
    ...
    py::class_<TrafficGraph>(m, "TrafficGraph")
      .def("render", [](const TrafficGraph &self, const std::vector<SummaryData> &data_rows,
                        const std::chrono::system_clock::time_point start_time,
                        const std::chrono::system_clock::time_point end_time) {
        return self.Render(data_rows, start_time, end_time);
      })
