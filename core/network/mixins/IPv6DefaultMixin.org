* IPv4DefaultMixins
This provides a default implementation for processing IPv6 packets. It uses an ~unordered_map~, as that is usually
...
#+begin_src c++ :tangle IPv6DefaultMixin.cppm
